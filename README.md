...
and slot work; this layer is only the agent. See [`docs/rauc.md`][rauc-doc] in the agent's
repository for what `system.conf` has to say, and [`docs/deploying.md`][deploy-doc]
for the service user, the identifier and the rest of the deployment contract.
...
[rauc-doc]: https://github.com/nerves-hub/nerves-hub-link-agent/blob/main/docs/rauc.md
[deploy-doc]: https://github.com/nerves-hub/nerves-hub-link-agent/blob/main/docs/deploying.md
